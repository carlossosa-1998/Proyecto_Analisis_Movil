...
const useDragScroll = () => {
    ...
    const onMouseMove = useCallback((e: React.MouseEvent) => {
        ...
        const walk = (y - startY) * 1.5; // Factor de velocidad de arrastre
...
export const ClienteDashboardView: React.FC<ClienteDashboardProps> = ({ onNavigate }) => {
  ...
  // Refs y estados para el desplazamientoo/arrastre con Mouse (Mouse Drag / Swipe)
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-4 pb-3 border-b border-gray-100 relative">
        <div className="text-left space-y-0.5 min-w-0">
          ...
          <p className="text-xs text-gray-500 font-medium tracking-wide leading-snug">
            Consola del cliente • Monitoreo operacional
          </p>
          <div className="pt-1">
            <div
              style={{
            ...
            >
              ...
              <span className="text-[9px] font-bold tracking-wider">Suscripción VIP</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 mb-4 text-left">
        ...
        >
          ...
          <p className="text-lg font-black text-gray-900 mb-0.5">35%</p>
          <p className="text-xs text-gray-400 font-semibold leading-snug">Reducción de recursos</p>
        </div>
        ...
        >
          ...
          <p className="text-lg font-black text-gray-900 mb-0.5">148 hrs</p>
          <p className="text-xs text-gray-400 font-semibold leading-snug">Tiempo optimizado</p>
        </div>
        ...
        >
          ...
          <p className="text-lg font-black text-gray-900 mb-0.5">320 Ha</p>
          <p className="text-xs text-gray-400 font-semibold leading-snug">Cobertura total</p>
        </div>
        ...
        >
          ...
          <p className="text-lg font-black text-gray-900 mb-0.5">12 casos</p>
          <p className="text-xs text-gray-400 font-semibold leading-snug">Alertas a tiempo</p>
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="relative">
          ...
          >
            <option value="riego">Riego de precisión</option>
            <option value="busqueda">Búsqueda y rescate</option>
            <option value="fumigacion">Fumigación y control</option>
            <option value="transporte">Transporte y entrega</option>
        ...
        <div className="flex flex-col gap-2.5 mb-3 pb-2 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0">
              <h3 className="text-sm font-black text-gray-900 tracking-wider">
                Rendimiento — {activeTab}
              </h3>
          ...
          <div className="flex flex-col gap-2 w-full">
            <div className="relative w-full">
              ...
              <input
                ...
                placeholder="Buscar ID, sector, dron..."
                style={{ borderRadius: "4px" }}
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h4 className="text-sm font-black text-gray-900 leading-snug">
              ¿Deseas Contratar Una Nueva Operación?
            </h4>
            <p className="text-xs text-gray-500 font-medium leading-snug">
              Accede al catálogo para solicitar tu próxima misión
            </p>
          </div>
        </div>
...
export const ClienteServiciosView = () => {
    ...
    const serviciosScroll = useDragScroll();
    ...
    // Estado del ID de mapeo y modales
    ...
    return (
        <div className="w-full h-full bg-gray-50 flex flex-col font-sans overflow-hidden relative select-none" style={{ fontFamily: "'Roboto', sans-serif" }}>
            <style>{`
                * {
                    -ms-overflow-style: none !important;
                    scrollbar-width: none !important;
            ...
            <div className="flex-1 overflow-hidden relative">
                ...
                {activeTab === "servicios" && (
                    <div
                        ref={serviciosScroll.ref}
                        {...serviciosScroll.events}
                        className="h-full overflow-y-auto touch-drag p-3 flex flex-col gap-3"
                    >
                                ...
                                >
                                    <div className="h-24 w-full relative overflow-hidden bg-gray-100 shrink-0">
                                        ...
                                        <div className="absolute bottom-2 left-3 right-3 flex justify-between items-end">
                                            <div>
                                                <span className="text-white text-xs font-medium block opacity-90">
                                                    {srv.type}
                                                </span>
                                            ...
                                            <div className={`flex items-center gap-1 px-2 py-0.5 rounded-[4px] border text-xs font-bold shadow-xs bg-white/95 backdrop-blur-xs ${getStatusBadge(srv.status)}`}>
                                                {srv.status}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-3 flex flex-col gap-2">
                                        <div className="flex flex-col gap-1.5">
                                            <div className="flex items-center gap-1 text-xs text-gray-500">
                                                ...
                                                <span className="font-medium text-xs truncate">{srv.location}</span>
                                            </div>
                                            <p className="text-xs text-gray-600 bg-gray-50 p-2 rounded-[4px] border border-gray-100 font-normal leading-relaxed">
                                                {srv.notes}
                                            </p>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-2 pt-2 border-t border-gray-100 items-center">
                                            <div>
                                                ...
                                                <p className="font-bold text-xs text-gray-700 flex items-center gap-1 mt-0.5">
                                            ...
                                            {srv.missionId && (
                                                <div className="flex flex-col items-end">
                                                    ...
                                                    <button
                                                        ...
                                                        className="font-bold text-[#0E5E6F] text-xs flex items-center gap-1 mt-0.5 cursor-pointer"
                                                        title="Copiar ID"
                                                    >
                        ...
                        <div className="w-full flex flex-col shrink-0">
                            <div className="w-full min-h-[340px] bg-white border border-gray-200 rounded-[4px] shadow-xs overflow-hidden flex flex-col">
                                ...
                                <div
                                    ref={formScroll.ref}
                                    {...formScroll.events}
                                    className="p-3.5 flex-1 flex flex-col justify-between overflow-y-auto touch-drag min-h-0"
                                >
                                    {requestSuccess ? (
                                        ...
                                        <>
                                                        ...
                                                        {formData.serviceType === "Dron con Mapeo" ? (
                                                            <div className="space-y-1.5">
                                                                <div className="p-2 bg-blue-50 border border-blue-200 rounded-[4px] text-left">
                                                                    ...
                                                                    <p className="text-xs text-blue-600 mt-0.5 mb-1.5 leading-tight">
                                                                        Abre el editor de mapas, prepara tu zona y copia el ID de la misión.
                                                                    </p>
                                                                    <button
                                                                        type="button"
                                                                        onClick={() => setActiveTab("mapas")}
                                                                        className="w-full text-xs font-bold bg-blue-600 hover:bg-blue-700 text-white px-2 py-1.5 rounded-[4px] shadow-xs flex justify-center items-center gap-1 transition-colors cursor-pointer"
                                                                    >
                                            ...
                                            {step === 3 && (
                                                <div className="flex flex-col gap-3">
                                                    <div>
                                                        <h3 className="text-xs font-bold text-gray-400 tracking-wider mb-1">
                                                            Resumen de Solicitud
                                                        </h3>
                                                        <div className="bg-gray-50 border border-gray-200 p-2.5 rounded-[4px] space-y-1.5">
                                                            <div>
                                                                <p className="text-xs text-gray-500 font-bold">Servicio</p>
                                                                <p className="text-xs font-bold text-gray-800">{formData.serviceTitle}</p>
                                                                <p className="text-xs text-[#0E5E6F] font-bold">{formData.serviceType}</p>
                                                            </div>
                                                            <div className="h-px bg-gray-200 w-full" />
                                                            <div>
                                                                <p className="text-xs text-gray-500 font-bold">Fecha y Lugar</p>
                                                                <p className="text-xs text-gray-700 font-medium">{formData.date} - {formData.location}</p>
                                                            </div>
                                                            {formData.serviceType === "Dron con Mapeo" && (
                                                                <>
                                                                    <div className="h-px bg-gray-200 w-full" />
                                                                    <div>
                                                                        <p className="text-xs text-gray-500 font-bold">ID Vinculado</p>
                                                                        <p className="text-xs text-gray-700 font-mono font-bold bg-white inline-block px-1 rounded-[4px] border border-gray-200">
                ...
                {activeTab === "mapas" && (
                    ...
                    >
                            ...
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <div className="text-left min-w-0">
                                    <div className="flex items-center gap-1.5">
                                        <h1 className="text-[10px] font-bold text-gray-900 tracking-tight">
                                            Editor de mapas
                                        </h1>
                                    </div>
                                    <button
                                        onClick={handleOpenIdModal}
                                        className="text-[8px] text-gray-500 font-medium leading-none hover:text-[#0E5E6F] transition-colors cursor-pointer text-left block"
                        ...
                        {activePanel === "dron" && (
                            <div className="absolute inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center px-3">
                                <div className="bg-white border border-gray-200 rounded-[4px] shadow-2xl max-w-xs w-full overflow-hidden text-left p-4 space-y-1 font-sans">
                                    <div className="flex items-center justify-between border-b border-gray-100 pb-2">
            ...
            {/* MODALES DEL SISTEMA (ABSOLUTOS AL CONTENEDOR) */}
            ...
            {isCopySuccessModalOpen && (
                <div className="absolute inset-0 z-50 bg-black/50 flex items-center justify-center p-4 backdrop-blur-xs">
                    <div className="bg-white rounded-[4px] border border-gray-200 p-5 shadow-2xl max-w-xs w-full text-center flex flex-col items-center">
                        <div className="w-10 h-10 bg-emerald-100 text-emerald-600 rounded-[4px] flex items-center justify-center mb-3">
                            ...
                            <div className="grid grid-cols-1 gap-3 items-stretch">
                                ...
                                <div className="bg-white border border-gray-200 rounded-[4px] p-3.5 shadow-xs flex flex-col justify-between gap-2">
                                    ...
                                    <div className="p-2 bg-amber-50 border border-amber-200 rounded-[4px] flex items-center gap-1.5 text-amber-900 text-[10px]">
                                        ...
                                        <span>Garantía de servicio y soporte de la red TECNODACTYLUS.</span>
                                    </div>
                                </div>
                            </div>
                        )}
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div>
                            <div className="mb-4">
                                ...
                                >
                                    <option value="generales">Planes generales</option>
                                    <option value="descuentos-drones">Descuentos en drones por plan</option>
                                    <option value="asistencia-tecnica">Asistencia técnica y taller</option>
                                    <option value="contratacion-piloto">Contratación de piloto</option>
                                </select>
                            </div>
                            ...
                            <div className="mb-4">
                                {activeTab === "generales" && (
                                    <Text className="text-xs text-gray-500 block">
                                        Suscripciones periódicas para servicios integrales de monitoreo aéreo, aspersión y análisis con la plataforma TECNODACTYLUS.
                                    </Text>
                                )}
                                {activeTab === "descuentos-drones" && (
                                    <Text className="text-xs text-gray-500 block">
                                        Obtén un porcentaje de descuento especial en la adquisición de tu dron al suscribir cualquiera de estos planes TECNODACTYLUS.
                                    </Text>
                                )}
                                {activeTab === "asistencia-tecnica" && (
                                    <Text className="text-xs text-gray-500 block">
                                        Planes dedicados de mantenimiento preventivo, reparaciones en campo y respaldo técnico integral TECNODACTYLUS.
                                    </Text>
                                )}
...
export const ClienteDronView = ({
    ...
    const [pilotFormData, setPilotFormData] = useState({
        email: "carlos.mendoza@tecnodactylus.hn",
    ...
    const catalogoDrones: Drone[] = [
        ...
        // MICRO (todos <250g, compra directa)
        {
            id: "micro-3",
        ...
        // MINI (todos <250g, compra directa)
        {
            id: "mini-3",
        ...
        // --- DRONES CON PESO > 250g (requieren piloto) ---
        {
            id: "pequeno-3",
            nombre: "DJI Air 3",
    ...
    return (
        <div style={{ fontFamily: "'Roboto', sans-serif" }} className="p-3 max-w-md mx-auto flex flex-col gap-4 text-left min-h-screen">
                            ...
                            <div className="bg-white border border-gray-200 rounded-[4px] p-3.5 shadow-xs flex flex-col justify-between gap-2">
                                <div>
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 p-1 bg-gray-100 rounded-[4px] border border-gray-200 mb-2.5">
                                        <button
                                            onClick={() => setPaymentMethod("card")}
                                            className={`py-1 px-2 rounded-[4px] text-xs flex items-center justify-center gap-1 transition cursor-pointer ${paymentMethod === "card"
                                                    ? "bg-[#0E5E6F] text-white shadow-xs font-bold"
                                                    : "text-gray-600 hover:text-gray-900 hover:bg-gray-200/60"
                                                }`}
                                        >
                                        ...
                                        <button
                                            onClick={() => setPaymentMethod("transfer")}
                                            className={`py-1 px-2 rounded-[4px] text-xs flex items-center justify-center gap-1 transition cursor-pointer ${paymentMethod === "transfer"
                                                    ? "bg-[#0E5E6F] text-white shadow-xs font-bold"
                                                    : "text-gray-600 hover:text-gray-900 hover:bg-gray-200/60"
                                                }`}
                                        >
                                        ...
                                        <button
                                            onClick={() => setPaymentMethod("qr")}
                                            className={`py-1 px-2 rounded-[4px] text-xs flex items-center justify-center gap-1 transition cursor-pointer ${paymentMethod === "qr"
                                                    ? "bg-[#0E5E6F] text-white shadow-xs font-bold"
                                                    : "text-gray-600 hover:text-gray-900 hover:bg-gray-200/60"
                                                }`}
                                        >
                                        ...
                                        <button
                                            onClick={() => setPaymentMethod("wallet")}
                                            className={`py-1 px-2 rounded-[4px] text-xs flex items-center justify-center gap-1 transition cursor-pointer ${paymentMethod === "wallet"
                                                    ? "bg-[#0E5E6F] text-white shadow-xs font-bold"
                                                    : "text-gray-600 hover:text-gray-900 hover:bg-gray-200/60"
                                                }`}
                                        >
                                ...
                                <div className="flex gap-3 items-start">
                                    ...
                                    <div>
                                        <div className="flex flex-wrap items-center gap-1.5 mb-1">
                                            <Title as="h3" className="text-sm font-bold text-amber-950">
                        ...
                        <div className="p-4 overflow-y-auto flex-1">
                            ...
                            {droneModalTab === 'info' && (
                                <div className="space-y-2 text-xs text-gray-700">
                                    ...
                                    {selectedCategory !== "micro" && (
                                        <div className="p-2 bg-amber-50 border border-amber-200 rounded-[4px] flex items-center gap-1.5 text-amber-800 text-[10px] font-medium">
                            ...
                            {droneModalTab === 'especificaciones' && (
                                <div className="space-y-2 text-xs text-gray-700">
                                    ...
                                    {selectedCategory !== "micro" && (
                                        <div className="p-2 bg-amber-50 border border-amber-200 rounded-[4px] flex items-center gap-1.5 text-amber-800 text-[10px] font-medium mt-3">
                                            <ShieldAlert size={14} className="shrink-0 text-amber-600" />
                                            <span>Requiere Cuenta de Piloto verificada para la compra.</span>
                                        </div>
                                    )}
                        ...
                        <div className="flex gap-2 p-3 pt-2 border-t border-gray-100 shrink-0">
                            ...
                            {selectedCategory === "micro" ? (
                                ...
                                <button
                                    ...
                                    className="flex-1 px-3 py-2 bg-amber-600 text-white font-bold text-xs rounded-[4px] hover:bg-amber-700 cursor-pointer shadow-xs flex items-center justify-center gap-1"
                                >
                                    <Lock size={12} />
                                    <span>Requiere Piloto</span>
                                </button>
                            )}
                        </div>
            ...
            {/* ============================================================ */}
            {/* MODAL DE CAMBIO A CUENTA PILOTO */}
            {/* ============================================================ */}
            {isPilotModalOpen && (
                <div className="absolute inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4 font-sans">
                    <div className="bg-white border border-gray-200 rounded-[4px] shadow-2xl max-w-xs w-full overflow-hidden text-left p-4 space-y-3">
                        ...
                        {!isSubmitted ? (
                            <form onSubmit={handlePilotSubmit} className="space-y-3">
                                <p className="text-xs text-gray-600 font-normal leading-tight">
                                    Para adquirir aeronaves de mayor categoría, ingresa tus credenciales y tu <strong className="text-gray-800">Código de la AHAC</strong> (Agencia Hondureña de Aeronáutica Civil).
                                </p>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border-2 border-gray-200 rounded-[4px] p-2 text-xs font-medium text-gray-800 focus:border-[#0E5E6F] outline-none"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border-2 border-gray-200 rounded-[4px] p-2 text-xs font-mono font-bold uppercase text-gray-800 focus:border-[#0E5E6F] outline-none"
                                    />
                                </div>
                                ...
                                <div className="flex justify-end gap-2 pt-2 border-t border-gray-100">
                                    ...
                                    <button
                                        type="submit"
                                        className="px-4 py-1.5 bg-amber-600 text-white font-bold text-xs rounded-[4px] hover:bg-amber-700 cursor-pointer shadow-xs flex items-center gap-1"
                                    >
                                        <Send size={12} />
                                        <span>Enviar Solicitud</span>
                                    </button>
                            ...
                            <div className="space-y-3 py-1">
                                ...
                                <p className="text-xs text-gray-600 font-normal">
                                    Tu solicitud ha sido enviada. Un <strong className="text-gray-800">administrador</strong> revisará tu código de la AHAC y se pondrá en contacto contigo en breve para completar la validación de tu cuenta.
                                </p>
                                <div className="flex justify-end pt-2 border-t border-gray-100">
                                    <button
                                        onClick={resetPilotForm}
    ...
    <div style={{ fontFamily: "'Roboto', sans-serif" }} className="p-4 max-w-full mx-auto bg-white antialiased text-gray-800 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 text-left">
        ...
        >
          ...
          <p className="text-sm font-black text-gray-900 mb-0.5">24 Operaciones</p>
          <p className="text-xs text-gray-400 font-semibold">Registros consolidados</p>
        </div>
        ...
        >
          ...
          <p className="text-sm font-black text-gray-900 mb-0.5">187.5 Ha</p>
          <p className="text-xs text-gray-400 font-semibold">Superficie analizada</p>
        </div>
        ...
        >
          ...
          <p className="text-sm font-black text-gray-900 mb-0.5">19 Archivos</p>
          <p className="text-xs text-gray-400 font-semibold">Documentos PDF listos</p>
        </div>
        ...
        >
          ...
          <p className="text-sm font-black text-gray-900 mb-0.5">Corporativo</p>
          <p className="text-xs text-gray-400 font-semibold">Plan de cobertura total</p>
        </div>
      </div>
        ...
        >
          <div className="flex items-center justify-between border-b-2 border-gray-100 pb-3 gap-2">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <h2 className="text-sm font-black text-gray-900 tracking-wider">
      ...
      {/* MODAL CENTRADO: DETALLES DEL VUELO */}
      {selectedVuelo && (
          ...
          <div className="bg-white border border-gray-200 rounded-[4px] shadow-2xl max-w-xs w-full overflow-hidden text-left p-4 space-y-3 font-sans">
            ...
            <div className="space-y-2 text-xs text-gray-700">
              ...
              {selectedVuelo.detallesTecnicos && (
                <div className="mt-3 p-2 bg-gray-50 border-2 border-gray-200 rounded-[4px] space-y-1">
                  <p className="font-bold text-gray-900 border-b pb-1 mb-1 text-xs">
                    Parámetros de Telemetría y Misión
                  </p>
                  <p className="text-[10px]"><strong>Altura promedio:</strong> {selectedVuelo.detallesTecnicos.alturaPromedio}</p>
                  <p className="text-[10px]"><strong>Duración del vuelo:</strong> {selectedVuelo.detallesTecnicos.duracionVuelo}</p>
                  <p className="text-[10px]"><strong>Resolución GSD:</strong> {selectedVuelo.detallesTecnicos.resolucionGSD}</p>
                  <p className="text-[10px]"><strong>Condiciones climáticas:</strong> {selectedVuelo.detallesTecnicos.condicionClimatica}</p>
                </div>
              )}
            </div>
            ...
            <div className="flex justify-end pt-2 border-t border-gray-100">
              <button
                type="button"
                onClick={() => setSelectedVuelo(null)}
                className="w-full py-1.5 bg-[#0E5E6F] text-white font-bold text-xs rounded-[4px] hover:bg-[#0a4754] cursor-pointer shadow-xs"
              >
                Cerrar
              </button>
            </div>
      ...
      {/* MODAL CENTRADO: RECIBO DE FACTURA */}
      {selectedFactura && (
        <div className="absolute inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white border border-gray-200 rounded-[4px] shadow-2xl max-w-xs w-full overflow-hidden text-left p-4 space-y-3 font-sans">
            <div className="flex items-center justify-between border-b border-gray-100 pb-2">
            ...
            <div className="space-y-2 text-xs text-gray-700">
              ...
              {selectedFactura.detallesPago && (
                <div className="mt-3 p-2 bg-gray-50 border-2 border-gray-200 rounded-[4px] space-y-1">
                  <p className="text-[10px]"><strong>Subtotal:</strong> {selectedFactura.detallesPago.subtotal}</p>
                  <p className="text-[10px]"><strong>Impuesto (15%):</strong> {selectedFactura.detallesPago.impuesto}</p>
                  <p className="font-bold text-gray-900 text-xs pt-1 border-t border-gray-200">
...
export const ClienteHelpView = () => {
      ...
      messages: [
        {
          id: 1,
          sender: 'other',
          text: '¡Hola Carlos! Bienvenido al centro de asistencia. ¿Dudas con los parámetros de escaneo?',
          time: '08:30 AM',
        },
        {
          id: 2,
          sender: 'granjero',
          text: 'Hola. ¿La batería del dron #2 alcanza para cubrir las 187 manzanas en un vuelo?',
          time: '08:32 AM',
        },
        {
          id: 3,
          sender: 'other',
          text: 'Recomendamos dividir la misión en 2 fases para no forzar el retorno de emergencia.',
          time: '08:35 AM',
        },
      ],
    },
      ...
      messages: [
        {
          id: 1,
          sender: 'other',
          text: 'Buenas tardes Carlos. Completamos el análisis multiespectral del sector norte.',
          time: 'Ayer',
        },
        {
          id: 2,
          sender: 'granjero',
          text: 'Excelente Mateo, ¿cuándo estarán cargados los PDF en mi panel?',
          time: 'Ayer',
        },
        {
          id: 3,
      ...
      messages: [
        {
          id: 1,
          sender: 'other',
          text: 'Hola Carlos, la renovación del plan profesional fue procesada correctamente.',
          time: '09:15 AM',
        },
        {
          id: 2,
      ...
      messages: [
        {
          id: 1,
          sender: 'granjero',
          text: 'Hola Diego, ¿cómo estuvo el viento durante el mapeo de la tarde?',
          time: 'Ayer',
        },
        {
          id: 2,
          sender: 'other',
          text: 'Todo en orden Carlos. Vientos estables de 12 km/h. La ortofoto quedó impecable.',
          time: 'Ayer',
        },
      ],
    },
  ...
  // Menú desplegable Header (3 puntos)
  const [isHeaderMenuOpen, setIsHeaderMenuOpen] = useState<boolean>(false);

  // Estados para Modal de Solicitud de Soporte (Multi-paso)
  ...
  const [helpForm, setHelpForm] = useState({
    ...
    prioridad: 'Media',
    mensaje: 'Hola, este es un mensaje para solicitar asistencia.',
  });
  ...
  const handleHelpNext = (e: React.FormEvent) => {
    e.preventDefault();
    setModalStep(2);
  };
  ...
  return (
    <div className="w-full h-full min-h-0 flex flex-col bg-white overflow-hidden relative font-sans">
        ...
        >
          ...
          >
            {activeChat.messages.map((msg) => {
              const isGranjeroMsg = msg.sender === 'granjero';

              return (
                <div
                  key={msg.id}
                  className={`flex items-end gap-2 ${
                    isGranjeroMsg ? 'justify-end' : 'justify-start'
                  }`}
                >
                  {!isGranjeroMsg && (
                    <img
                  ...
                  >
                    ...
                    <div
                      className={`flex items-center justify-end gap-1 mt-1 text-[10px] ${
                        isGranjeroMsg ? 'text-cyan-100' : 'text-gray-400'
                      }`}
                    >
                      <span>{msg.time}</span>
      ...
      {/* ================= MODAL SOLICITAR AYUDA (MULTI-PASO) ================= */}
      {isHelpModalOpen && (
        <div className="absolute inset-0 bg-black/50 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-white w-[92%] max-w-[360px] rounded-[4px] shadow-2xl overflow-hidden border border-gray-100 flex flex-col max-h-[92%]">
            ...
            >
              {!isSubmitted ? (
                modalStep === 1 ? (
                  <form onSubmit={handleHelpNext} className="space-y-3">
                    <div>
                      ...
                      >
                        <option value="Incidencia técnica">Falla en dron</option>
                        <option value="Error en telemetría">
                          Error de telemetría
                        </option>
                ...
                <div className="py-3 text-center space-y-2.5">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-gray-600 max-w-xs mx-auto leading-relaxed">
                      El equipo de soporte ha sido notificado correctamente.
                    </p>
                  </div>
                  <div className="pt-1">
                    <button
...
export const ClienteProfileView = ({ onLogout }: ClienteProfileViewProps) => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    email: "mario.ica@tecnodactylus.hn",
    phone: "+504 9788-4411",
  ...
  const [isPilotModalOpen, setIsPilotModalOpen] = useState(false);
  const [isPilotSubmitted, setIsPilotSubmitted] = useState(false);
  ...
  // Datos para el modal de edición normal
  ...
  // Datos para el modal de Piloto AHAC
  const [pilotForm, setPilotForm] = useState({
    email: "piloto.mario@tecnodactylus.hn",
    password: "password123",
  ...
  const handleFakeUpload = () => {
    ...
    setTimeout(() => {
      setIsUploading(false);
      setSimulatedFile("foto_perfil.jpg");
    }, 600);
  };
  ...
  const handleSendPilotData = (e: React.FormEvent) => {
    e.preventDefault();
    setIsPilotSubmitted(true);
  };
        ...
        <div className="bg-gray-50 border-b-2 border-gray-200 px-4 py-4 flex flex-col items-start gap-3">
          <div className="flex items-center gap-3 w-full">
            ...
            <div className="text-left min-w-0 flex-1">
              <h2 className="text-lg text-gray-900 font-black tracking-tight normal-case leading-tight">
                {profileData.name}
              </h2>
          ...
          <div className="flex flex-col items-center gap-2 w-full">
            ...
            <button
              ...
              className={`w-full text-center text-[10px] font-black tracking-wider px-3 py-1 rounded-[4px] border-2 break-words whitespace-normal flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-95 ${profileData.roleColor}`}
            >
              <span>{profileData.roleLabel}</span>
              <span className="text-[9px] bg-[#0E5E6F] text-white px-1.5 py-0.5 rounded-[2px] font-bold shrink-0">
                Cambiar
              </span>
            </button>
            ...
            {saveSuccess && (
              <span className="text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-300 px-2.5 py-0.5 rounded-[4px] flex items-center gap-1 animate-in fade-in duration-150">
                <CheckCircle size={12} /> Actualizado
              </span>
            )}
          </div>
        </div>
            ...
            <div className="px-3.5 pt-3 pb-2.5 space-y-2.5 overflow-y-auto">
              ...
              {!isPilotSubmitted ? (
                <>
                  ...
                  <form onSubmit={handleSendPilotData} className="space-y-2">
                    <div>
                      <label className="block text-[10px] font-black text-gray-500 tracking-wider mb-1">
                        Correo electrónico
                      </label>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <ShieldCheck size={13} className="absolute left-3 top-2.5 text-gray-400" />
                        <input
                          type="text"
                          value={pilotForm.ahacCode}
                          onChange={(e) => setPilotForm({ ...pilotForm, ahacCode: e.target.value })}
                          className="w-full pl-8 pr-3 py-1.5 text-xs font-bold border-2 border-gray-200 rounded-[4px] focus:border-[#0E5E6F] focus:outline-none bg-white text-gray-800 uppercase"
                          required
                        />
                      </div>
                    </div>
                ...
                /* CONFIRMACIÓN DE ENVÍO DE PILOTO */
                <div className="py-2 text-center space-y-3 animate-in zoom-in-95 duration-150">
                  <div className="w-10 h-10 bg-emerald-50 border-2 border-emerald-300 rounded-full flex items-center justify-center mx-auto text-emerald-600">
                    <CheckCircle2 size={22} />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-medium text-gray-600 leading-tight px-1">
                      Tus datos y credenciales AHAC han sido registrados. Un administrador revisará tu solicitud.
                    </p>
                  </div>

                  <div className="p-2 bg-amber-50 border-2 border-amber-200 rounded-[4px] flex items-center gap-1.5 text-left">
                    <Clock size={14} className="text-amber-600 shrink-0" />
                    <span className="text-[9px] font-bold text-amber-800 leading-tight">
                      Tiempo estimado de verificación: 24 a 48 horas.
                    </span>
                  </div>
                  ...
                  <div className="pt-1.5 border-t border-gray-100">
                    <button
                      type="button"
                      onClick={() => setIsPilotModalOpen(false)}
                      className="w-full py-2 bg-[#0E5E6F] border-2 border-[#0E5E6F] text-white font-bold rounded-[4px] text-xs transition-all active:scale-95 shadow-xs cursor-pointer"
                    >
                      Entendido
                    </button>
                  </div>
