...
import { BarChart2, Check, CheckCircle, Edit2, Eye, EyeOff, Layers, LogOut, Mail, MapPin, Lock, Phone, Save, Settings, Wrench, X, ChevronDown, Bell, Sliders, Trash2, Activity, AlertTriangle, BarChart3, ChevronRight, Clock, Cpu, DollarSign, Download, Package, SearchIcon, ShieldCheck, Zap, CheckCheck, CheckCircle2, MoreVertical, Paperclip, Search, Send, Video, User, Briefcase, ClipboardCheck, Calendar, Compass, Camera, Loader2, Upload, AlertCircle, ArrowLeft, Building2, CreditCard, Network, QrCode, UserCheck, Wallet, XCircle, Edit3, Filter, Users } from 'lucide-react';
        ...
        {[
          ...
          return (
            <button
              key={tab.id}
              onClick={() => {
                setActiveTab(tab.id as OriginType);
                setStatusFilter("ALL");
              }}
              style={{ borderRadius: "4px 4px 0 0" }}
                ...
                <div className="flex flex-col gap-5">
                    ...
                    {planActual && (
                        <div className="bg-white border border-[#0E5E6F] rounded-[4px] p-4 shadow-xs flex flex-col gap-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs bg-gray-50/80 p-3 rounded-[4px] border border-gray-200/80">
                                ...
                                <div className="flex items-center gap-2 border-t sm:border-t-0 sm:border-l border-gray-200 pt-1.5 sm:pt-0 sm:pl-3">
                                    <Network size={16} className="text-[#0E5E6F] shrink-0" />
                                    <div>
                                        <span className="text-[9px] uppercase text-gray-400 block">
                                            Rol de enlace
                                        </span>
                    ...
                    <div>
                        <div className="border-b-2 border-gray-200 mb-6 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-1 select-none">
                            {[
                                { id: "gestion-solicitudes", label: "Gestión de solicitudes", icon: <Layers size={13} /> },
                                { id: "comisiones-intermediacion", label: "Comisiones e intermediación", icon: <Zap size={13} /> },
                                { id: "soporte-herramientas", label: "Herramientas y diagnóstico", icon: <Wrench size={13} /> },
                                { id: "alianzas-tecnicas", label: "Alianzas y repuestos", icon: <UserCheck size={13} /> },
                            ].map((tab) => {
                                const isActive = activeTab === tab.id;
                                return (
                                    <button
...
export const TecnicoHelpView = () => {
    ...
    },
    {
      ...
      messages: [
        ...
        },
        {
          id: 2,
          sender: 'tecnico',
          text: 'Perfecto Sofia, paso por bodega en la tarde para el ingreso al inventario técnico.',
          time: 'Lunes',
        },
      ],
    },
  ...
  const [supportForm, setSupportForm] = useState({
    equipo: 'Dron #2 - DJI Agras T40',
    categoria: 'Falla Mecánica / Motores',
    prioridad: 'Alta (Equipo Detenido)',
    descripcion: '',
  });
  ...
  return (
    <div className="w-full h-full min-h-0 flex flex-col bg-white overflow-hidden relative font-sans">
          ...
          <div className="p-4 border-b border-gray-200 bg-white flex items-center justify-between shrink-0">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Consultas técnicas & administración
              </p>
            </div>
        ...
        <div className="flex-1 flex flex-col h-full min-h-0 bg-[#f8fafc] overflow-hidden">
          ...
          <div className="p-3 sm:p-4 bg-white border-b border-gray-200 flex items-center justify-between gap-2 shrink-0 min-w-0">
            ...
            <div className="flex items-center gap-1 text-gray-500 shrink-0">
              ...
              <button
                className="p-2 hover:bg-gray-100 text-gray-600 hover:text-[#0E5E6F] rounded transition"
                aria-label="Videollamada de diagnóstico"
              >
                <Video size={18} />
              </button>
          ...
          >
            <button
              ...
              title="Adjuntar esquemático, fotografía o log de error"
            >
              <Paperclip size={20} />
            </button>
            ...
            <input
              type="text"
              placeholder="Escribe tu mensaje o consulta de taller..."
              value={inputText}
      ...
      {/* ================= MODAL DE SOLICITUD DE ASISTENCIA TÉCNICA Y DIAGNÓSTICO ================= */}
      {isModalOpen && (
            ...
            <div className="p-4 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Soporte directo de fábrica / supervisión
                  </p>
                </div>
              </div>
              <button
                ...
                <form onSubmit={handleSupportSubmit} className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setSupportForm({ ...supportForm, equipo: e.target.value })
                      }
                    ...
                    >
                      ...
                      <option value="Pack Baterías Inteligentes (BS60/DB1560)">
                        Pack baterías inteligentes
                      </option>
                      <option value="Sistema de Fumigación / Bombas">
                        Sistema de fumigación / bombas
                      </option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      <option value="Falla Mecánica / Motores">
                        Falla mecánica / esc / motores
                      </option>
                      <option value="Error de Firmware / Software">
                        Error de firmware / actualización
                      </option>
                      <option value="Sensores / Gimbal / Óptica">
                        Calibración de gimbal / cámara
                      </option>
                      <option value="Requerimiento de Repuestos">
                        Solicitud / faltante de repuestos
                      </option>
                      <option value="Garantía de Fábrica">
                        Validación de garantía de fábrica
                      </option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Media">Media (espera de piezas)</option>
                      <option value="Alta (Equipo Detenido)">
                        Alta (equipo inoperativo en taller)
                      </option>
                      <option value="Urgente">
                        Urgente (falla crítica de seguridad / riesgo)
                      </option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      required
                      rows={4}
                      placeholder="Indica lecturas de multímetro, códigos de error en log, piezas inspeccionadas y pruebas realizadas..."
                ...
                <div className="py-6 text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-600 max-w-xs mx-auto leading-relaxed">
                      La solicitud de asistencia técnica ha sido enviada al
                      equipo de ingeniería y administración de flota.
                    </p>
                  </div>
                  <div className="pt-2">
                    <button
